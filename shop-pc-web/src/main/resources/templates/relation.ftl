...
<div class="nb">
    <div class="ny-body ny-zsy">
        ...
        <div class="right">
            <div class="form-box">
                <#if error ?? >
                    <span style="color: red; font-size: 18px;"> ${error} </span> </#if>
                <form action="gitLoginAndBindUser" method="post">
                    <h3>电商系统GITHUB关联现有账户</h3>
                    <div class="bind">
                        <a href="register" class="blue">注册新账号关联</a>
                    </div>
