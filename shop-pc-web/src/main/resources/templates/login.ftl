				...
				<div class="form-box">
					...
					<div class="hezuo oauth">
						...
						<ul>
							...
							<a href="/gitHubConnectLogin">
								<img alt="GitHub" title="Sign in with GitHub" class="js-lazy-loaded qa-js-lazy-loaded" src="/view/default/images/github.png" style="width: 30px">
							</a>
